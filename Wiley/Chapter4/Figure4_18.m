%----------------------------------------------------------------
% This code can be used to generate Figure 4-18
%----------------------------------------------------------------
clear all
close all
...
load Esplanorteta60 % load E-scattered
...
matplot2(X(M:-1:1),Y,abs(ISARnew.'),22); % form the image
